...
This analysis looks at the figures for Covid-19 cases in England. It's a little dig into what this data can - and can't - tell us.
...
```{r identify areas with widespread infection rates, results='asis'}
