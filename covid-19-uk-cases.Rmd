...
<!-- ## Cases, hospitalisation, intensive care and death -->

<!-- It's useful to understand the relationships between numbers of cases, numbers of people in hospital, numbers in intensive care, and deaths from Covid-19. We'll look at these at a very aggregated level, just in England, to understand their relationship. -->
...
```{r upcoming tier 3 restrictions}
...
```{r upcoming tier 2 restrictions}
