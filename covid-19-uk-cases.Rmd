...
for (area in currentRestrictions) {
...
previousRestrictions = restrictedAreas[!(restrictedAreas %in% currentRestrictions)]
...
worrisomeAreas = worrisomeAreas[!(worrisomeAreas %in% currentRestrictions)]
